return {
    ...
    config = function()
        ...
        ts_config.setup({
            -- make sure we have vim, vimdoc, lua, java, javascript, typescript, html, css, json, xml,tsx, markdown, markdown, inline markdown and gitignore highlighting servers
            ensure_installed = {"vim","bash", "vimdoc", "lua", "java", "html", "css", "xml" ,"json", "tsx", "markdown", "markdown_inline", "gitignore"},
